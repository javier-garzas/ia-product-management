...
> 🧩 **Aparte del flujo:** dos skills **complementarias** operan a nivel de **equipos y organización**, no de feature, por eso no aparecen en esta línea: [`diseno-organizacional-agil`](skills/diseno-organizacional-agil/) (estructura y topología de equipos, unFix + Team Topologies) y [`management-3-0-y-equipos-agiles`](skills/management-3-0-y-equipos-agiles/) (liderazgo y motivación, Management 3.0).
...
Este material se publica bajo licencia **[Creative Commons Attribution 4.0 (CC BY 4.0)](LICENSE)** — la licencia abierta que más ayuda a que esto crezca:

- ✅ Puedes **usarlo, compartirlo, adaptarlo y traducirlo**, incluso con fines comerciales.
- ☝️ La **única condición**: **citar la autoría** (Javier Garzás — 233 Academy).
