...
| [`hipotesis-de-epica`](skills/hipotesis-de-epica/) | Enmarca una épica como una **hipótesis testeable** (si/entonces): acción, persona y resultado esperado, más los experimentos ligeros para validarla y las medidas de éxito antes de construir. Para tratar las iniciativas como apuestas con criterios de cierre, no como promesas. |
| [`estrategia-producto-ia`](skills/estrategia-producto-ia/) | Define la estrategia de producto con IA usando el método propio **ED2A** (Eliminar · Delegar · Agilizar · Automatizar → IA): la IA como último recurso, no como primer reflejo. Incluye el filtro de las 4 variables y los principios de estrategia de IA de referentes del sector. Contra el "IA por el simple hecho de usar IA". |
