<!--
  ...
  Licencia: CC BY 4.0 (la misma que el repo).
...
> Licencia **CC BY 4.0** (como el repositorio). Complementa a las skills [`crear-historias-de-usuario`](../skills/crear-historias-de-usuario/) y [`crear-spec-sdd`](../skills/crear-spec-sdd/), que usan criterios de aceptación en Gherkin.
